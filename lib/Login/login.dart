...
class _LoginScreenState extends State<LoginScreen> {
  ...
  loginApp(context) {
    ...
    var host = "secure-temple-09752.herokuapp.com";
    var path = "/login";
    var scheme = "http";
    http.post(Uri(scheme: scheme, host: host, path: path),
        body: {"email": controllerEmail.text, "senha": controllerSenha.text}).then((response) {
                  ...
                  child: Column(children: [
                    Center(
                      child: Image.asset('assets/natuvida_logo.png',
                          height: (MediaQuery.of(context).size.height * 0.4), color: Colors.green),
                    ),
                    Padding(
